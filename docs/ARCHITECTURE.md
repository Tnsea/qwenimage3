...
- Committed account-required revision `67155fc8fdb8769e1e1babde61887e0431aed668` is deployed as Worker `9e63c7c1-1b9e-4c78-a608-5853dbfadbdd`. The Kie.ai Qwen Image 2 path completed both a direct Worker acceptance task and one signed-in product request with four-credit settlement, private R2 persistence, and browser rendering. Paid Starter now receives original, watermark-free exports while retaining the standard queue; Creator and Professional retain both original exports and VIP priority. Failure/timeout behavior and provider commercial approval remain open.
