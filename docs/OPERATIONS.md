...
| `BILLING_ENABLED` | `false` on the canonical acceptance Worker | Enable new Stripe Checkout offers | Keep false until the public-billing gates pass; signed webhooks and external cleanup remain active when credentials exist |
