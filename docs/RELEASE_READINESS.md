...
- Create-conversation commit `1d6e731` runs in acceptance as Worker `15017717-b14a-42e3-8a9f-c7a4afa7c96a`; it has not yet been pushed and has no matching GitHub CI run, so it cannot yet be promoted as a production release;
...
- Source revision and CI: committed revision `1d6e731eb0eab8ad8f41246fb160ae63f8ecff94`; local release verification passed with 116 tests, production artifact scanning, and zero production dependency findings. This commit has not yet been pushed and has no matching GitHub CI run; historical run `30062662075` applies only to earlier revision `dd38e44`
...
The Worker and client runtime content are represented by committed revision `1d6e731eb0eab8ad8f41246fb160ae63f8ecff94`. Push, matching GitHub CI, review, merge, and a release marker remain pending. This record documents acceptance evidence and the explicit Checkout operating decision only—not a Ready or production-approval decision.
