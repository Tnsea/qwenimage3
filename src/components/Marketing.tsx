...
export function HomeSections({ catalog, onNavigate, onUsePrompt, onRegister }: { catalog: Catalog } & NavigateProps) {
  const faqs = [
    ...
    ["analytics", "Do you use analytics?", "GA4 remains off unless you allow optional analytics. It measures page visits without ad personalization; prompts, generated images, and account identifiers are not sent. You can change the choice from the site footer."],
